    ...
    for i in range(n):
        for j in range(n):
            if i==j:
                ...
                assert I[i,j]==0
#---------------------------------------------------
def test_matrix_multiplication_6pt():
