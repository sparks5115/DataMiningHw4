...
def test_update_I_7pt():
    ...
    assert np.allclose(I,I_true,atol=0.1)
#---------------------------------------------------
def test_collaborative_filtering_8pt():
