...
def transpose(X):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_transpose_3pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_transpose_3pt
        ---------------------------------------------------
    '''
...
def identity_matrix(n):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_identity_matrix_3pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_identity_matrix_3pt
        ---------------------------------------------------
    '''
...
#----------------------------------------------------
'''
    Given two matrices X (of shape r X k) and Y (k X c), compute the matrix multiplication between the matrix X and Y: Z = X Y 
...
def matrix_multiplication(X, Y):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_matrix_multiplication_6pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_matrix_multiplication_6pt
        ---------------------------------------------------
    '''
...
def matrix_inverse(X):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_matrix_inverse_6pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_matrix_inverse_6pt
        ---------------------------------------------------
    '''
...
def is_missing(x):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_is_missing_3pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_is_missing_3pt
        ---------------------------------------------------
    '''
...
def inverse(m):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_inverse_3pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_inverse_3pt
        ---------------------------------------------------
    '''
...
def subset_vector(x, m):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_subset_vector_3pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_subset_vector_3pt
        ---------------------------------------------------
    '''
...
def subset_matrix(X, m):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_subset_matrix_3pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_subset_matrix_3pt
        ---------------------------------------------------
    '''
...
''' 
    TEST problem 1: (30 points)
        ...
        ----------- test session starts --------------------- 
        * (3 points) test1.py::transpose_3pt  PASSED 
        * (3 points) test1.py::identity_matrix_3pt  PASSED 
        * (6 points) test1.py::matrix_multiplication_6pt  PASSED 
        * (6 points) test1.py::matrix_inverse_6pt  PASSED 
        * (3 points) test1.py::is_missing_3pt  PASSED 
        * (3 points) test1.py::inverse_3pt  PASSED 
        * (3 points) test1.py::subset_vector_3pt  PASSED 
        * (3 points) test1.py::subset_matrix_3pt  PASSED 
